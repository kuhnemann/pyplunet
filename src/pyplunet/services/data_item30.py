...
class DataItem30:
    ...
    def get_language_independent_item_object(
        ...
        elif type(currency_type) is int:
    ...
    def get_price_unit_list(
        ...
        """
        Deprecated. Please use DataAdmin30.getAvailablePriceUnits(String, String, String) instead.
    ...
    def insert_price_line(
        ...
        if type(price_line_in) is not PriceLineIN:
    ...
    def update_prices(
        ...
        """
        Applies prices from the pricelist currently set in the item to all price lines of the item
        ...
        proxy = self.__client.plunet_server.DataItem30.updatePrices
        response_model = Result
    ...
    def get_price_unit(self, price_unit_id: int, language_code: str) -> PriceUnitResult:
        ...
        Possible price units can be retrieved using DataAdmin30.getAvailablePriceUnits(java.lang.String, java.lang.String, java.lang.String)
    ...
    def get_items_by_status4_by_currency_type(
        ...
        if type(document_status) is DocumentStatus:
            document_status = document_status.value
        elif type(document_status) is int:
            document_status = document_status
        else:
            document_status = int(document_status)

        if type(current_type) is CurrencyType:
            current_type = current_type.value
        elif type(current_type) is int:
