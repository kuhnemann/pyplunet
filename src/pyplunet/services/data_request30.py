...
class DataRequest30:
    ...
    def update(
        ...
        if type(request_in) is not RequestIN:
    ...
    def search(
        ...
        if type(search_filter) is not SearchFilter_Request:
    ...
    def get_request_object(self, request_id: int) -> RequestResult:
        ...
        WARNING: This call can cause performance issues.
    ...
    def get_request_list(
        ...
        """
        Method returns an instance of RequestListResult, which contains a list of Request objects without its derived orders and quotes.
        ...
        proxy = self.__client.plunet_server.DataRequest30.getRequestList
        response_model = RequestListResult

        if type(request_id_list) is not IntegerList:
